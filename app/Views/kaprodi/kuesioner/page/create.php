...
<div class="bg-white rounded-xl shadow-md p-8 w-full mx-auto">
    <div class="-mx-8 mb-6 border-b border-gray-300 pb-3 px-8 flex items-center">
    ...
    <form action="<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/store") ?>" method="post" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="title" required class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300 focus:outline-none">
        </div>

        <div>
            <label class="block font-medium mb-1">Deskripsi</label>
            <textarea name="description" rows="3" class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300 focus:outline-none"></textarea>
        </div>

        <div>
            <label class="block font-medium mb-1">Urutan</label>
            <input type="number" name="order_no" value="1" min="1" required class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-300 focus:outline-none">
        </div>
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages") ?>" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded-lg">Batal</a>
        </div>
    </form>
</div>
