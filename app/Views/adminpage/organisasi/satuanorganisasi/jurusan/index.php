    ...
    <div class="page-container">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="<?= base_url('admin/jurusan/create') ?>" class="btn-primary">
        ...
        <!-- Search -->
        <form method="get" action="<?= base_url('admin/jurusan') ?>" class="search-form">
                                ...
                                <tr>
                                    ...
                                    <td class="action-cell">
                                        <div class="action-buttons">
                                            ...
                                            <!-- Edit -->
                                            <a href="<?= base_url('admin/jurusan/edit/' . $row['id']) ?>" 
                                            ...
                                            <form id="deleteForm-<?= $row['id'] ?>" 
                                                  action="<?= base_url('admin/jurusan/delete/' . $row['id']) ?>" 
                                                  method="post" 
