...
<link href="<?= base_url('css/respon/detail_ami.css') ?>" rel="stylesheet">
        ...
        <div class="header-container mb-8">
            <div class="header-top">
                <div class="header-left">
                    <h1 class="page-title"> Detail Alumni - <span class="badge-ami-title">AMI</span></h1>
                </div>
                <a href="<?= base_url('admin/respon/ami'); ?>" class="btn-kembali">
                        Kembali
                </a>
            </div>
        </div>
        ...
        <?php if (empty($alumni)) : ?>
            ...
            <div class="empty-card">
                <div class="empty-state">
                    ...
                    <p class="empty-text">Tidak ada alumni yang termasuk dalam data AMI.</p>
                </div>
            </div>
        <?php else : ?>
            <!-- Filter Card -->
            <div class="filter-card mb-6">
                <form method="get" class="filter-form">
                    ...
                    <div class="filter-actions">
                        <a href="<?= base_url('admin/respon/ami/pdf/' . urlencode($opsi)); ?>" target="_blank" class="btn-export">
                            📄 Export PDF
                        </a>
                    </div>
                </form>
